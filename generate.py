...
#     data['surgery'] = np.where((data['tumor_size'] < 2) & (data['lymph_nodes'] < 2) & (data['stage'] < 3), 'Lumpectomy', 'Mastectomy')
#     data['surgery'] = np.where(data['tumor_size'] < 1, 'Lumpectomy', data['surgery'])
#     data['surgery'] = np.where((data['stage'] < 2) & (data['lymph_nodes'] < 1), 'Lumpectomy', data['surgery'])
...
#     data['radiotherapy'] = np.where((data['surgery'] == 'Lumpectomy') | ((data['stage'] > 1) & ((data['lymph_nodes_post_hormone'] > 1) | (data['tumor_size_post_hormone'] > 2))), 'Yes', 'No')
#     data['radiotherapy'] = np.where((data['lymph_nodes_post_hormone'] > 1) | (data['tumor_size_post_hormone'] > 2), 'Yes', data['radiotherapy'])
#     data['radiotherapy'] = np.where((data['stage'] > 2) & (data['surgery'] == 'Mastectomy'), 'Yes', data['radiotherapy'])
...
#     # Treatment decision 1: Surgery
#     data['surgery'] = np.where((data['tumor_size'] < 2) & (data['lymph_nodes'] < 2) & (data['stage'] < 3), 'Lumpectomy', 'Mastectomy')
#     data['surgery'] = np.where((data['tumor_size'] < 1) & (data['lymph_nodes'] == 0), 'Lumpectomy', data['surgery'])
#     data['surgery'] = np.where((data['stage'] == 1) & (data['lymph_nodes'] < 2) & (data['tumor_size'] < 3), 'Lumpectomy', data['surgery'])
#     data['surgery'] = np.where((data['age'] > 70) & (data['stage'] < 3) & (data['lymph_nodes'] < 2) & (data['tumor_size'] < 4), 'Lumpectomy', data['surgery'])
...
def generate_synthetic_data(num_samples):
    ...
    # Treatment decision 1: Surgery
    # # data['surgery'] = np.where((data['stage'] <= 2) & (data['tumor_size'] <= 3) & (data['lymph_nodes'] <= 2) & (data['er_status'] == 'Positive') & (data['her2_status'] == 'Negative'), 'Lumpectomy', 'Mastectomy')
    # data['surgery'] = np.where((data['stage'] == 1) & (data['tumor_size'] <= 3) & (data['lymph_nodes'] == 0) & (data['er_status'] == 'Positive') & (data['her2_status'] == 'Negative'), 'Lumpectomy', 'Mastectomy')
    # data['surgery'] = np.where((data['stage'] == 2) & (data['tumor_size'] <= 5) & (data['lymph_nodes'] <= 3) & (data['er_status'] == 'Positive') & (data['her2_status'] == 'Negative'), 'Lumpectomy', data['surgery'])
    # # data['surgery'] = np.where((data['age'] >= 60) & (data['stage'] <= 2) & (data['tumor_size'] <= 5) & (data['lymph_nodes'] <= 2) & (data['er_status'] == 'Positive') & (data['her2_status'] == 'Negative'), 'Lumpectomy', data['surgery'])
    # data['surgery'] = np.where((data['age'] >= 60) & (data['stage'] <= 4) & (data['tumor_size'] <= 5) & (data['lymph_nodes'] <= 2) & (data['er_status'] == 'Positive') & (data['her2_status'] == 'Negative'), 'Lumpectomy', data['surgery'])
    # data['surgery'] = np.where((data['er_status'] == 'Negative') | (data['her2_status'] == 'Positive'), 'Mastectomy', data['surgery'])
    # # data['surgery'] = np.where((data['stage'] > 2) | (data['tumor_size'] > 5) | (data['lymph_nodes'] > 4), 'Mastectomy', data['surgery'])
    ...
    # data['surgery'] = np.where((data['stage'] <= 2) & (data['tumor_size'] <= 3) & (data['lymph_nodes'] <= 2) & (data['er_status'] == 'Positive') & (data['her2_status'] == 'Negative'), 'Lumpectomy', 'Mastectomy')
    # data['surgery'] = np.where((data['stage'] == 1) & (data['tumor_size'] <= 2) & (data['lymph_nodes'] <= 1), 'Lumpectomy', data['surgery'])
    # data['surgery'] = np.where((data['stage'] == 2) & (data['tumor_size'] <= 3) & (data['lymph_nodes'] <= 2) & (data['er_status'] == 'Positive') & (data['her2_status'] == 'Negative') & (data['grade'] <= 2), 'Lumpectomy', data['surgery'])
    # data['surgery'] = np.where((data['age'] >= 60) & (data['stage'] <= 2) & (data['tumor_size'] <= 3) & (data['lymph_nodes'] <= 1) & (data['er_status'] == 'Positive') & (data['her2_status'] == 'Negative') & (data['grade'] <= 2), 'Lumpectomy', data['surgery'])
    # data['surgery'] = np.where((data['stage'] > 2) | (data['tumor_size'] > 5) | (data['lymph_nodes'] > 4), 'Mastectomy', data['surgery'])

    # for key in data:
    #     data[key] = pd.Series(data[key])

    # # Adjust the distribution of surgery decisions
    # surgery_dist = data['surgery'].value_counts(normalize=True)
    # if surgery_dist['Lumpectomy'] < 0.4:
    #     lumpectomy_indices = data[data['surgery'] == 'Lumpectomy'].index
    #     mastectomy_indices = data[data['surgery'] == 'Mastectomy'].index
        
    #     num_convert = int((0.4 - surgery_dist['Lumpectomy']) * num_samples)
    #     convert_indices = np.random.choice(mastectomy_indices, size=num_convert, replace=False)
        
    #     data.loc[convert_indices, 'surgery'] = 'Lumpectomy'
    ...
    # Treatment decision 4: Radiotherapy
    # data['radiotherapy'] = np.where((data['surgery'] == 'Lumpectomy') | ((data['stage'] > 1) & ((data['lymph_nodes_post_hormone'] > 1) | (data['tumor_size_post_hormone'] > 2))), 'Yes', 'No')
    # data['radiotherapy'] = np.where((data['lymph_nodes_post_hormone'] > 1) | (data['tumor_size_post_hormone'] > 2) | (data['lymph_nodes'] > 0), 'Yes', data['radiotherapy'])
    # data['radiotherapy'] = np.where((data['stage'] > 2) & (data['surgery'] == 'Mastectomy') & (data['tumor_size'] > 5) & (data['lymph_nodes'] > 0), 'Yes', data['radiotherapy'])
